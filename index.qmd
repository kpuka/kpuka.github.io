...
:::{#hero-heading}
# Klajdi Puka
*Behavioural Scientist | PhD Epidemiology & Biostatistics*

I am a behavioural scientist with a passion research methods, R, and data visualization. My skills are at the intersection of behevioural science, statistics, and knowledge translation.
...
I also provide statistical and methodological consulting services at a nominal fee; for more information, click here [here](pages/consulting.qmd). 
...
<style>
  ...
  .button-container a {
    flex: 1;
    max-width: 200px; /* Adjust this value to make the buttons wider */
    margin-right: 35px; /* Adds spacing between the buttons, adjust as desired */
  }
